            ...
            <div class="mt-6">
                ...
                <div class="grid grid-cols-2 gap-3 text-center">
                    <div class="bg-green-50 rounded-xl p-3">
                        <p id="presentCount" class="text-2xl font-bold text-green-600">{{ isset($presentCount) ? $presentCount : 0 }}</p>
                        <p class="text-xs text-gray-600">Present</p>
                    </div>
                    <div class="bg-red-50 rounded-xl p-3">
                        <p id="absentCount" class="text-2xl font-bold text-red-600">{{ isset($absentCount) ? $absentCount : 0 }}</p>

...
@section('title-content', 'Buat Testimoni Baru')
        ...
        <div class="container mx-auto p-4">
            <div class="container mx-auto p-4">
                <div class="bg-[#FFF9E3] p-8 rounded-xl shadow-lg">
                    <form method="POST" action="{{ route('admin.landing_store') }}">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="name" name="name_student" placeholder="Nama lengkap"
                        ...
                        <div class="mb-6">
                            <label for="text" class="block text-gray-700 font-semibold mb-2">Sekolah</label>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="review_text" name="review_text" placeholder="Testimoni" rows="3"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500 shadow-sm border-red-500"
                                {{ old('review_text') }}>
                            </textarea>
                        </div>

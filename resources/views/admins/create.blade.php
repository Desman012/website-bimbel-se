        ...
        <div class="container mx-auto p-4">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="name" name="name" placeholder="Nama lengkap" 
                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 shadow-sm @error('name') border-red-500 @enderror"
                       value="{{ old('name') }}">
                @error('name')
            ...
            <div class="mb-6">
                ...
                <input type="email" id="email" name="email" placeholder="Alamat email" 
                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 shadow-sm @error('email') border-red-500 @enderror"
                       value="{{ old('email') }}">
                @error('email')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-6">
                <label for="phone" class="block text-gray-700 font-semibold mb-2">No. Handphone/WA</label>
                <input type="text" id="phone" name="phone" placeholder="Nomor telepon" 
                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 shadow-sm @error('phone') border-red-500 @enderror"
                       value="{{ old('phone') }}">
                @error('phone')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-6">
                ...
                <textarea id="address" name="address" placeholder="Alamat tempat tinggal" rows="3"
                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 shadow-sm @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
                @error('address')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            <div class="flex justify-end mt-8">
                <button type="submit" 
                        class="px-6 py-2 bg-orange-300 hover:bg-orange-400 text-white font-semibold rounded-lg shadow-md transition duration-150">
                    Send
                </button>
            </div>
        </form>
